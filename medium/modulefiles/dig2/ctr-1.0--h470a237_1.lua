local help_message = [[
This is a module file for the container quay.io/biocontainers/dig2:1.0--h470a237_1, which exposes the
following programs:
...
set_shell_function("dig2",'singularity exec ${BIOCONTAINER_DIR}/biocontainers/dig2/dig2-1.0--h470a237_1.simg dig2 $@','singularity exec ${BIOCONTAINER_DIR}/biocontainers/dig2/dig2-1.0--h470a237_1.simg dig2 $*')
